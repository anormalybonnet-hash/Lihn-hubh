...
if _G.SelectMonster == ‘Pirate’ then
MMon = ‘Pirate’
...
if _G.SelectMonster == ‘Military Soldier’ then
...
if _G.SelectMonster == ‘Fishman Warrior’ then
...
```
        ...
        _ParticleEmitter.SpreadAngle = Vector2.new(0, 0)
...
local v480 = _Character and not *Character:FindFirstChild(‘HasBuso’) and game:GetService(‘ReplicatedStorage’).Remotes.CommF*
...
function CheckRace()
local *Wenlocktoad = game:GetService(‘ReplicatedStorage’).Remotes.CommF*:InvokeServer(‘Wenlocktoad’, ‘1’)
local *Alchemist = game:GetService(‘ReplicatedStorage’).Remotes.CommF*:InvokeServer(‘Alchemist’, ‘1’)
...
Discord = ‘https://discord.gg/MgWTh3Y3DY’,
})
...
_ImageButton.Image = ‘rbxassetid://119013242553516’
...
```
        ...
        u707:Set('Status: ' .. v712 .. ' Eye(s)' .. (v712 == 4 and ' ������' or ''))
    end)
end
```
...
while task.wait(1) do
pcall(function()
local *Bones = game:GetService(‘ReplicatedStorage’).Remotes.CommF*:InvokeServer(‘Bones’, ‘Check’)
...
while wait(0.1) do
if *G.Rdbone then
game:GetService(‘ReplicatedStorage’).Remotes.CommF*:InvokeServer(‘Bones’, ‘Buy’, 1, 1)
end
end
end)
v632:AddToggle({
...
wait()
game:GetService(‘ReplicatedStorage’).Remotes.CommF*:InvokeServer(‘gravestoneEvent’, 1)
end
end
end)
end)
...
TP1(CFrame.new(-8652.99707, 143.450119, 6170.50879, -0.983064115, -2.48005533e-10, 0.18326205, -1.78910387e-9, 1, -8.24392288e-9, -0.18326205, -8.43218029e-9, -0.983064115))
wait()
game:GetService(‘ReplicatedStorage’).Remotes.CommF*:InvokeServer(‘gravestoneEvent’, 2)
end
end
end)
end)
...
while task.wait(1) do
pcall(function()
local *CakePrinceSpawner = game:GetService(‘ReplicatedStorage’).Remotes.CommF*:InvokeServer(‘CakePrinceSpawner’)
...
spawn(function()
while wait() do
if *G.Fullykatakuri then
pcall(function()
if game.Players.LocalPlayer.Backpack:FindFirstChild(“God’s Chalice”) or game.Players.LocalPlayer.Character:FindFirstChild(“God’s Chalice”) then
if string.find(game:GetService(‘ReplicatedStorage’).Remotes.CommF*:InvokeServer(‘SweetChaliceNpc’), ‘Where’) then
...
u839:Set(‘Status: Boss Spawn ✅’)
else
u839:Set(‘Status: Boss Not Spawn ❌’)
end
end)
end
end)
...
Value = false,
Callback = function()
game:GetService(‘ReplicatedStorage’).Remotes.CommF*:InvokeServer(unpack({
‘CraftItem’,
‘Craft’,
‘Volcanic Magnet’,
}))
...
u1070:Set(‘Prehistoric Island Spawning ✅’)
else
u1070:Set(‘Prehistoric Island Not Spawn ❌’)
end
end)
end
end)
...
u1181:Set(‘Kitsune Island Spawning ✅’)
else
u1181:Set(‘Kitsune Island Not Spawn ❌’)
end
end)
end
end)
...
pcall(function()
if not game:GetService(‘Workspace’).Boats:FindFirstChild(‘PirateBrigade’) then
game:GetService(‘ReplicatedStorage’).Remotes.CommF*:InvokeServer(‘BuyBoat’, ‘PirateBrigade’)
end
end)
end
end
...
u1251:Set(‘Mirage Island Spawning ✅’)
else
u1251:Set(‘Mirage Island Not Spawn ❌’)
end
end)
end
end)
...
```
    if not v1386 then
        v1380 = v1380 .. '- Không có trái nào.
```

’
end
else
v1380 = v1380 .. ’- ❌ Lỗi khi lấy dữ liệu.
’
end
...
```
    if not v1395 then
        v1389 = v1389 .. '- Không có trái nào.
```

’
end
else
v1389 = v1389 .. ’- ❌ Lỗi khi lấy dữ liệu.
’
end
...
elseif *G.SelectIsland == ‘Sky Island 2’ then
game:GetService(‘ReplicatedStorage’).Remotes.CommF*:InvokeServer(‘requestEntrance’, Vector3.new(-4607.823, 872.543, -1667.557))
elseif *G.SelectIsland == ‘Sky Island 3’ then
game:GetService(‘ReplicatedStorage’).Remotes.CommF*:InvokeServer(‘requestEntrance’, Vector3.new(-7894.618, 5547.142, -380.291))
elseif _G.SelectIsland == ‘Prison’ then
u1402(CFrame.new(4875.33, 5.652, 734.85))
elseif _G.SelectIsland ~= ‘Magma Village’ then
if *G.SelectIsland == ‘Under Water Island’ then
game:GetService(‘ReplicatedStorage’).Remotes.CommF*:InvokeServer(‘requestEntrance’, Vector3.new(61163.852, 11.68, 1819.784))
...
elseif *G.SelectIsland == ‘Castle On The Sea’ then
game:GetService(‘ReplicatedStorage’).Remotes.CommF*:InvokeServer(‘requestEntrance’, Vector3.new(-5083.26, 314.606, -3175.673))
elseif _G.SelectIsland == ‘Port Town’ then
u1402(CFrame.new(-226.751, 20.603, 5538.34))
elseif _G.SelectIsland == ‘Hydra Island’ then
u1402(CFrame.new(5291.249, 1005.443, 393.762))
elseif _G.SelectIsland ~= ‘Floating Turtle’ then
if *G.SelectIsland == ‘Mansion’ then
game:GetService(‘ReplicatedStorage’).Remotes.CommF*:InvokeServer(‘requestEntrance’, Vector3.new(-12471.17, 374.94, -7551.678))
...
pcall(function()
while wait(0.1) do
if *G.AutoPlayerHunter and game:GetService(‘Players’).LocalPlayer.PlayerGui.Main.PvpDisabled.Visible == true then
